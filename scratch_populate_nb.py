...
cells = [
    new_markdown_cell("# 🚢 Titanic Survival Prediction using Artificial Neural Networks (ANN)\nIn this notebook, we build and train an Artificial Neural Network (ANN) using **TensorFlow/Keras** to predict passenger survival on the Titanic."),
...
"""),
    ...
    new_markdown_cell("## 3. Data Cleaning and Preprocessing"),
    new_code_cell("""# Check missing values
...
# 4. Drop columns that won't be used directly in the baseline ANN
...
print("titanic_ANN.ipynb written successfully!")
